			...
			<div className="container mx-auto px-4">
				...
				>
					...
					<p className="text-gray-600 max-w-2xl mx-auto">
						Découvrez notre gamme complète de services pour transformer votre
						vision en réalité. Notre expertise combine créativité et technologie
						pour créer des solutions digitales performantes.
					</p>
				</motion.div>
